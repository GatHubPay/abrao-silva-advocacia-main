...
const PrevidenciarioIcon: React.FC<SVGIconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.001 512.001" className={className}>
...
const TrabalhistaIcon: React.FC<SVGIconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 512 512" className={className}>
...
const CivilIcon: React.FC<SVGIconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" height="512" viewBox="0 0 248.386 237.182" width="512" className={className}>
    <g>
...
const PublicoEstatutarioIcon: React.FC<SVGIconProps> = ({ className }) => (
  <svg aria-hidden="true" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg" className={className}>
