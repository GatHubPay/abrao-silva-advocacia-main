    ...
    <div className="bg-white flex flex-col">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="flex flex-col items-end space-y-3">
          ...
          {/* Botão do WhatsApp */}
          <a
            href={`https://wa.me/${cityConfig.whatsapp}?text=Olá! Gostaria de falar com um advogado especializado em ${cityConfig.displayName}.`}
            target="_blank"
            rel="noopener noreferrer"
            className="wp-animate-button bg-green-500 hover:bg-green-600 text-white p-4 rounded-full transition-all duration-300 shadow-2xl btn-hover-scale animate-bounce-gentle hover:shadow-green-500/50 group relative overflow-hidden"
          >
            {/* Efeito shimmer */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-500 ease-out rounded-full"></div>
            
            {/* Ícone do WhatsApp */}
            <svg className="h-8 w-8 group-hover:scale-110 transition-transform duration-300 relative z-10" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Indicador online */}
            <div className="absolute -top-1 -right-1 bg-green-400 border-2 border-white rounded-full w-4 h-4 animate-pulse"></div>
          </a>
        </div>
      </div>
