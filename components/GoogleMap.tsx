...
export default function GoogleMapComponent() {
  ...
  const openGoogleMaps = useCallback(() => {
    const address = encodeURIComponent('Rua 100, Nº 35, Qd. F-17, Lt. 12, Setor Sul - Goiânia, GO');
      ...
      <div className="absolute top-4 left-4 bg-white p-3 rounded-lg shadow-lg border">
        <div className="flex items-center gap-2 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-black">Rua 100, Nº 35</p>
            <p className="text-xs text-black">Qd. F-17, Lt. 12, Setor Sul</p>
            <p className="text-xs text-black">Goiânia, GO</p>
          </div>
        </div>
        <button
          onClick={openGoogleMaps}
