...
const center = {
  lat: -13.2750, // Coordenadas de São Miguel do Araguaia
  lng: -50.1628
};
...
export default function GoogleMapComponent() {
  ...
  const openGoogleMaps = useCallback(() => {
    const address = encodeURIComponent('Av. Mato Grosso, casa 2, quadra 58, lote p2, setor central - São Miguel do Araguaia, GO');
      ...
      <div className="relative w-full h-80 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg overflow-hidden shadow-lg">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600">São Miguel do Araguaia - GO</p>
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                      ...
                      Av. Mato Grosso, casa 2<br />
                      quadra 58, lote p2, setor central<br />
      ...
      <div className="absolute top-4 left-4 bg-white p-3 rounded-lg shadow-lg border">
        <div className="flex items-center gap-2 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-black">Av. Mato Grosso, casa 2</p>
            <p className="text-xs text-black">quadra 58, lote p2, setor central</p>
            <p className="text-xs text-black">São Miguel do Araguaia, GO</p>
          </div>
        </div>
        <button
          onClick={openGoogleMaps}
